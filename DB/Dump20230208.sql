...
--
-- Host: localhost    Database: db_study_202210_02
-- ------------------------------------------------------
...
--
-- Current Database: `db_study_202210_02`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `db_study_202210_02` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;

USE `db_study_202210_02`;
...
INSERT INTO `emp_mst` VALUES (1,'김경민',32,'01089683970');
...
INSERT INTO `user_mst` VALUES (1,'aaaaa','1234','김준일','abc@abc.com'),(2,'bbbbb','1234','김준일','abc@abc.com'),(3,'ccccc','1234','김준일','abc@abc.com'),(4,'ddddd','1234','김준일','abc@abc.com'),(5,'eeeee','1234','김준일','abc@abc.com');
/*!40000 ALTER TABLE `user_mst` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'db_study_202210_02'
--

--
-- Dumping routines for database 'db_study_202210_02'
--
...
INSERT INTO `book_image` VALUES (2,'소록-999','가짜이름2.png','진짜이름2.png'),(3,'소록-999','가짜이름3.png','진짜이름3.png'),(4,'소록-999','가짜이름4.png','진짜이름4.png'),(8,'소록-990','b5dfeffa8c024f16926739866b84837e.jpg','sample.jpg'),(9,'소록-5','f9d59a4b9faa44adab02e367c734e595.jpg','main_background.jpg');
...
INSERT INTO `book_like` VALUES (2,1,2),(3,2,1),(4,3,1),(5,4,1),(6,4,1),(7,4,1),(8,1,1),(9,478,1),(10,478,2),(11,478,3),(12,478,4),(13,477,1),(14,477,2),(15,477,3),(16,477,4),(17,477,5),(18,477,6);
...
INSERT INTO `rental_dtl` VALUES (1,1,471,'2023-01-17'),(2,1,472,NULL),(3,1,473,NULL),(4,10,400,'2023-01-19');
...
INSERT INTO `rental_mst` VALUES (1,1,'2023-01-17','2023-01-31'),(2,1,'2023-01-17','2023-01-31'),(3,1,'2023-01-17','2023-01-31'),(10,2,'2023-01-19','2023-02-02');
...
INSERT INTO `role_dtl` VALUES (5,1,1,'2023-01-10 20:23:09','2023-01-10 20:23:09'),(6,2,1,'2023-01-19 19:27:59','2023-01-19 19:27:59');
...
INSERT INTO `role_mst` VALUES (1,'ROLE_USER','2023-01-05 20:51:47','2023-01-05 20:51:47'),(2,'ROLE_ADMIN','2023-01-05 20:51:47','2023-01-05 20:51:47'),(3,'ROLE_USER','2023-01-05 21:06:31','2023-01-05 21:06:31'),(4,'ROLE_ADMIN','2023-01-05 21:06:31','2023-01-05 21:06:31');
...
LOCK TABLES `user_mst` WRITE;
/*!40000 ALTER TABLE `user_mst` DISABLE KEYS */;
INSERT INTO `user_mst` VALUES (1,'aaa','$2a$10$T/MAU0S9fW7DlhI31dKiIOTZXpxam2s6L6N4rTwses0hM10g2k0NW','김경민','abcd@naver.com','2023-01-10 20:23:09','2023-01-10 20:23:09'),(2,'bbb','$2a$10$8FUtZoWi5upkK4MZwsEBTu7axycBq3r.5bEyoy6Ha1cMSx1ezI4He','김경민','antcjswo@naver.com','2023-01-19 19:27:59','2023-01-19 19:27:59');
/*!40000 ALTER TABLE `user_mst` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Current Database: `db_study_202210_01`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `db_study_202210_01` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
-- Dump completed on 2023-02-08 21:45:27
